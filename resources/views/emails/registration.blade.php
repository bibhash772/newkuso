						...
						<tr>
							<td style="padding: 0 20px;" > 
								...
								<p style="color: #333333; line-height: 24px; font-family:Arial, Helvetica, sans-serif; padding-top: 5px; font-size: 13px; margin: 0;">
									We created your {{ $data->account_type }} account and your email id is {{$data->email_id}} Please click <a href="{{ $data->url}}">here</a> or copy and paste below link to generate your password and activate your account.</p>
								<p style="color: #333333; line-height: 24px; font-family:Arial, Helvetica, sans-serif; padding-top: 5px; font-size: 13px; margin: 0;">
									{{$data->url}}
								</p>
