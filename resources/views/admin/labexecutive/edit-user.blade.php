                                    ...
                                    <div class="col-md-12">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="/admin/home">Home</a></li>
                                             <li class="breadcrumb-item"><a >Edit Lab Exevutive</a></li>
                                        </ul>
                                    </div>
                                </div>
                        	</div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                           @if(Session::has('message'))
                                            ...
                                            @endif
                                        <form id="add-user" action="/admin/labexecutive-edit/{{$user->user_id}}" method="post">
                                            {{csrf_field()}}
                                            <div class="row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <input type="zip_code" class="form-control" name="zip_code" value="{{@$user->zip_code}}" placeholder="Zip Code">
                                                        </div>
                                                    </div>
                                                </div>
                                                 <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <input type="country" class="form-control" name="country" value="{{@$user->country}}" placeholder="Country">
                                                        </div>
                                                    </div>
                                                </div>
                                                  <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <input type="address" class="form-control" name="address" value="{{@$user->address}}" placeholder="Address">
                                                        </div>
                                                    </div>
                                                </div>
                                             <div class="col-md-6">
